...
def max_three(d):# функция имеет несколько сложный вид, но я так вижу)))
    ...
    A = d.copy()
    B = d.copy()
    def max_dict_value(x,y): # функция ищет одно максимальное значение и проводит некоторые операции с копией исходного словаря для дальнейшей обработки, а также делает выходной словарь
        z = max(x.values())
